...
public class TarjetaListado extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TarjetaListado
     */
    ...
    private void initComponents() {
        ...
        tblTarjeta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Numero", "Intereces", "Credito"
            }
        ));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        List<Tarjeta> terjetas = TarjetaDAO.obtener();
        DefaultTableModel modelo = (DefaultTableModel) tblTarjeta.getModel();
        modelo.setRowCount(0);

        for (Tarjeta t : terjetas) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TarjetaListado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TarjetaListado().setVisible(true);
            }
        });
    }
